...
namespace leetcode {
    extern void test_twoSum();                                  // 0001
    extern void test_addTwoNumbers();                           // 0002
    extern void test_lengthOfLongestSubstring();                // 0003
    ...
    extern void test_hasValidParentheses();                     // 0020
